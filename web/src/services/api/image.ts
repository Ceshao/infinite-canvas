...
// 上游此处用非官方的 responseFormat.image 字段；官方 Gemini API 是
// generationConfig.imageConfig，Google 对未知字段会报 INVALID_ARGUMENT，
// 故按官方字段移植（aspectRatio 全模型可用，imageSize 仅 gemini-3 系）。
